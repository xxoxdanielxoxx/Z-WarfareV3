...
var oldPos : Vector3;
var pos : Vector3;
var OCDCDOQDOC : GUISkin;
var OOCQQCOQDD : GUISkin;
var showGui : int;
var ODCCDCQCDQ : boolean;
var count:int = 0;
function OnEnable(){
...
if(target.objectScript.ODDODDCCDCs == null)target.objectScript.ODDODDCCDCs = new GameObject[0];
...
else if(target.objectScript.ODDODDCCDCs.length <= 1  && !target.objectScript.ODODDDOO) ERMarkerGUI(target);
else  if(target.objectScript.ODDODDCCDCs.length == 2 && !target.objectScript.ODODDDOO) MSMarkerGUI(target);
else if(target.objectScript.ODODDDOO)TRMarkerGUI(target);


}
function OnSceneGUI() {
if(target.objectScript.OOCQCQDOQO == null || target.objectScript.erInit == "") Selection.activeGameObject =  target.transform.parent.parent.gameObject;
else MarkerOnScene(target);
}
function EasyRoadsGUIMenu(flag : boolean, senderIsMain : boolean,  nRoadScript : RoadObjectScript) : int {
if((target.objectScript.OQOCOQQOCQ == null || target.objectScript.ODCQOOQDQO == null || target.objectScript.OQQCCDODCO == null) && target.objectScript.OOCQCQDOQO){
target.objectScript.OQOCOQQOCQ = new boolean[5];
target.objectScript.ODCQOOQDQO = new boolean[5];
target.objectScript.OQQCCDODCO = nRoadScript;

target.objectScript.OOCCDDOQCQ = target.objectScript.OOCQCQDOQO.OQQCCQOOCQ();
target.objectScript.ODODQOQO = target.objectScript.OOCQCQDOQO.OCQDDDDCDO();
target.objectScript.ODODQOQOInt = target.objectScript.OOCQCQDOQO.OCODQCOODQ();
}else if(target.objectScript.OOCQCQDOQO == null) return;

if(target.objectScript.OCDCDOQDOC == null){
target.objectScript.OCDCDOQDOC = Resources.Load("ER3DSkin", GUISkin);
target.objectScript.OQQCQOOQCQ = Resources.Load("ER3DLogo", Texture2D);
}
if(!flag) target.objectScript.OCQQQOOOOC();
GUI.skin = target.objectScript.OCDCDOQDOC;
EditorGUILayout.Space();
EditorGUILayout.BeginHorizontal ();
GUILayout.FlexibleSpace();
target.objectScript.OQOCOQQOCQ[0] = GUILayout.Toggle(target.objectScript.OQOCOQQOCQ[0] ,new GUIContent("", " Add road markers. "),"AddMarkers",GUILayout.Width(40), GUILayout.Height(22));
if(target.objectScript.OQOCOQQOCQ[0] == true && target.objectScript.ODCQOOQDQO[0] == false) {
target.objectScript.OCQQQOOOOC();
target.objectScript.OQOCOQQOCQ[0] = true;  target.objectScript.ODCQOOQDQO[0] = true;
Selection.activeGameObject =  target.transform.parent.parent.gameObject;
}
target.objectScript.OQOCOQQOCQ[1]  = GUILayout.Toggle(target.objectScript.OQOCOQQOCQ[1] ,new GUIContent("", " Insert road markers. "),"insertMarkers",GUILayout.Width(40),GUILayout.Height(22));
if(target.objectScript.OQOCOQQOCQ[1] == true && target.objectScript.ODCQOOQDQO[1] == false) {
target.objectScript.OCQQQOOOOC();
target.objectScript.OQOCOQQOCQ[1] = true;  target.objectScript.ODCQOOQDQO[1] = true;
Selection.activeGameObject =  target.transform.parent.parent.gameObject;
}
target.objectScript.OQOCOQQOCQ[2]  = GUILayout.Toggle(target.objectScript.OQOCOQQOCQ[2] ,new GUIContent("", " Process the terrain and create road geometry. "),"terrain",GUILayout.Width(40),GUILayout.Height(22));

if(target.objectScript.OQOCOQQOCQ[2] == true && target.objectScript.ODCQOOQDQO[2] == false) {
...
target.objectScript.OQOCOQQOCQ[2] = false;
}else{
target.objectScript.OQOCOQQOCQ[2] = false;
Selection.activeGameObject =  target.transform.parent.parent.gameObject;
...
if(target.objectScript.OQOCOQQOCQ[2] == false && target.objectScript.ODCQOOQDQO[2] == true){

target.objectScript.ODCQOOQDQO[2] = false;
Selection.activeGameObject =  target.transform.parent.parent.gameObject;
}
target.objectScript.OQOCOQQOCQ[3]  = GUILayout.Toggle(target.objectScript.OQOCOQQOCQ[3] ,new GUIContent("", " General settings. "),"settings",GUILayout.Width(40),GUILayout.Height(22));
if(target.objectScript.OQOCOQQOCQ[3] == true && target.objectScript.ODCQOOQDQO[3] == false) {
target.objectScript.OCQQQOOOOC();
target.objectScript.OQOCOQQOCQ[3] = true;  target.objectScript.ODCQOOQDQO[3] = true;
Selection.activeGameObject =  target.transform.parent.parent.gameObject;
}
target.objectScript.OQOCOQQOCQ[4]  = GUILayout.Toggle(target.objectScript.OQOCOQQOCQ[4] ,new GUIContent("", "Version and Purchase Info"),"info",GUILayout.Width(40),GUILayout.Height(22));
if(target.objectScript.OQOCOQQOCQ[4] == true && target.objectScript.ODCQOOQDQO[4] == false) {
target.objectScript.OCQQQOOOOC();
target.objectScript.OQOCOQQOCQ[4] = true;  target.objectScript.ODCQOOQDQO[4] = true;
Selection.activeGameObject =  target.transform.parent.parent.gameObject;
}
GUILayout.FlexibleSpace();
EditorGUILayout.EndHorizontal();
GUI.skin = null;
target.objectScript.ODCDODOQQO = -1;
for(var i : int  = 0; i < 5; i++){
if(target.objectScript.OQOCOQQOCQ[i]){
target.objectScript.ODCDODOQQO = i;
target.objectScript.OCODOOCDCO = i;
}
}
if(target.objectScript.ODCDODOQQO == -1) target.objectScript.OCQQQOOOOC();
var markerMenuDisplay : int = 1;
if(target.objectScript.ODCDODOQQO == 0 || target.objectScript.ODCDODOQQO == 1) markerMenuDisplay = 0;
else if(target.objectScript.ODCDODOQQO == 2 || target.objectScript.ODCDODOQQO == 3 || target.objectScript.ODCDODOQQO == 4) markerMenuDisplay = 0;
if(target.objectScript.ODQDCQQQDO && !target.objectScript.OQOCOQQOCQ[2] && !target.objectScript.ODODDQOO){
target.objectScript.ODQDCQQQDO = false;
if(target.objectScript.objectType != 2)target.objectScript.ODDDCQDDDQ();
if(target.objectScript.objectType == 2 && target.objectScript.ODQDCQQQDO){
Debug.Log("restore");
target.objectScript.OOCQCQDOQO.OOOOCQQCOC(target.transform, true);
}
}
GUI.skin.box.alignment = TextAnchor.UpperLeft;
if(target.objectScript.ODCDODOQQO >= 0 && target.objectScript.ODCDODOQQO != 4){
if(target.objectScript.OOCCDDOQCQ == null || target.objectScript.OOCCDDOQCQ.Length == 0){
...
EditorGUILayout.BeginHorizontal();
GUILayout.Box(target.objectScript.OOCCDDOQCQ[target.objectScript.ODCDODOQQO], GUILayout.MinWidth(253), GUILayout.MaxWidth(1500), GUILayout.Height(50));
EditorGUILayout.EndHorizontal();
EditorGUILayout.Space();
}
return target.objectScript.ODCDODOQQO;
}
...
EditorGUILayout.Space();
if(target.distance == "-1" && target.objectScript.OOCQCQDOQO != null){
var arr = target.objectScript.OOCQCQDOQO.OODCOQCODQ(target.markerNum);
target.distance = arr[0];
target.OQCQOCOOCQ = arr[1];
target.OOCOCCDQOQ = arr[2];
}
GUILayout.Label("   Total Distance to Marker: " + target.distance.ToString() + " km");
GUILayout.Label("   Segment Distance to Marker: " + target.OQCQOCOOCQ.ToString() + " km");
GUILayout.Label("   Marker Distance: " + target.OOCOCCDQOQ.ToString() + " m");
EditorGUILayout.Space();
EditorGUILayout.BeginVertical("Box");
EditorGUILayout.LabelField(" Marker Settings", EditorStyles.boldLabel);
EditorGUILayout.EndVertical();
var oldss : boolean = markerScript.OODCCQOOOQ;
EditorGUILayout.BeginHorizontal();
...
GUI.SetNextControlName ("OODCCQOOOQ");
markerScript.OODCCQOOOQ = EditorGUILayout.Toggle (markerScript.OODCCQOOOQ);
EditorGUILayout.EndHorizontal();
if(markerScript.OODCCQOOOQ){
EditorGUILayout.BeginHorizontal();
...
markerScript.OODDCQQOOD = EditorGUILayout.Slider(markerScript.OODDCQQOOD, 0, 500);
EditorGUILayout.EndHorizontal();
EditorGUILayout.Space();
}
if(oldss != markerScript.OODDCQQOOD) target.objectScript.ResetMaterials(markerScript);
...
target.objectScript.ODCDDODCQO("ri", markerScript);
...
target.objectScript.ODCDDODCQO("li", markerScript);
...
target.objectScript.ODCDDODCQO("rs", markerScript);
...
target.objectScript.ODCDDODCQO("ls", markerScript);
...
target.objectScript.ODCDDODCQO("rt", markerScript);
...
target.objectScript.ODCDDODCQO("lt", markerScript);
...
target.objectScript.ODCDDODCQO("floorDepth", markerScript);
...
target.objectScript.ODOQQOCOQO();
}
GUILayout.FlexibleSpace();
EditorGUILayout.EndHorizontal();
}
if (GUI.changed && !target.objectScript.ODQCCCDCCQ){
target.objectScript.ODQCCCDCCQ = true;
}else if(target.objectScript.ODQCCCDCCQ){
target.objectScript.OCOOCQQCOO(markerScript);
target.objectScript.ODQCCCDCCQ = false;
...
target.objectScript.OOCQCQDOQO.OQDCQCQDCO(target.objectScript.ODDODDCCDCs, 0);
target.objectScript.ODOQQOCOQO();
}
GUILayout.FlexibleSpace();
EditorGUILayout.EndHorizontal();
...
Undo.RegisterUndo(target.transform.parent.GetComponentsInChildren(typeof(Transform)), "Marker align");
target.objectScript.OOCQCQDOQO.OQDCQCQDCO(target.objectScript.ODDODDCCDCs, 1);
target.objectScript.ODOQQOCOQO();
}
GUILayout.FlexibleSpace();
EditorGUILayout.EndHorizontal();
...
Undo.RegisterUndo(target.transform.parent.GetComponentsInChildren(typeof(Transform)), "Marker align");
target.objectScript.OOCQCQDOQO.OQDCQCQDCO(target.objectScript.ODDODDCCDCs, 2);
target.objectScript.ODOQQOCOQO();
}
GUILayout.FlexibleSpace();
EditorGUILayout.EndHorizontal();
...
Undo.RegisterUndo(target.transform.parent.GetComponentsInChildren(typeof(Transform)), "Marker align");
target.objectScript.OOCQCQDOQO.OQDCQCQDCO(target.objectScript.ODDODDCCDCs, 3);
target.objectScript.ODOQQOCOQO();
}
GUILayout.FlexibleSpace();
EditorGUILayout.EndHorizontal();
...
GUI.skin = target.objectScript.OOCQQCOQDD;
...
ODDQQCODQO.OCCDCOQOOO(target.objectScript.transform, target.objectScript.ODODDQOO[target.objectScript.ODOQOOQO]);
RoadObjectEditorScript.OQOQQDQOQQ(target.objectScript, target.objectScript.OOQQQOQO[target.objectScript.ODOQOOQO], target.objectScript);
...
RoadObjectEditorScript.OCQDOQQOQQ(target.objectScript);
...
if(cEvent.shift && (target.objectScript.OCODOOCDCO == 0 || target.objectScript.OCODOOCDCO == 1)) {
Selection.activeGameObject =  markerScript.transform.parent.parent.gameObject;
}else if(cEvent.shift && target.objectScript.ODDODDCCDC != target.transform){
target.objectScript.OOOOCCOOOO(markerScript);
Selection.objects = target.objectScript.ODDODDCCDCs;
}else if(target.objectScript.ODDODDCCDC != target.transform && count == 0){
if(!target.InSelected()){
target.objectScript.ODDODDCCDCs = new GameObject[0];
target.objectScript.OOOOCCOOOO(markerScript);
Selection.objects = target.objectScript.ODDODDCCDCs;
...
oldPos = pos;
if(!cEvent.shift){
target.objectScript.OQODQCOOQC(markerScript);

if(target.objectScript.objectType == 2) RoadObjectEditorScript.OCQDOQQOQQ(target.objectScript);	
}
}
}
