...
for(i = 0; i < ODQDQQOODQ.roadObjects.Length; i++){
comboValues.Add(ODQDQQOODQ.roadObjects[i]);
}
...
ODQDQQOODQ.OQDDCQCQQO.Add(thisso);
}
}
}

ODQDQQOODQ.roadObjects = comboValues.ToArray();
ODQDQQOODQ.OOCDDOQCOD();
